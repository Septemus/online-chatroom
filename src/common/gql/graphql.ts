...
export type UpdateFieldFragment = { __typename?: 'Users', id: string, website?: string | null, bio?: string | null, gender?: Gender | null, name: string } & { ' $fragmentName'?: 'UpdateFieldFragment' };
