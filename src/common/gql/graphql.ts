...
export type MessageQueryQuery = { __typename?: 'Query', Message?: { __typename?: 'Message', notes: Array<{ __typename?: 'Note', content: string, createdDate: any }>, usersInvolved: Array<{ __typename?: 'Users', email: string }> } | null };
